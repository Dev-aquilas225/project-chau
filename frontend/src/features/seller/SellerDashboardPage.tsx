    ...
    <div className="container-app py-8">
      ...
      <div className="mb-8 grid gap-4 sm:grid-cols-3">
        <div className="rounded-lg border border-line p-4">
          <p className="text-sm text-muted">Articles actifs</p>
          <p className="text-2xl font-semibold">{activeListings}</p>
        </div>
        <div className="rounded-lg border border-line p-4">
          <p className="text-sm text-muted">Commandes reçues</p>
          <p className="text-2xl font-semibold">{orders.length}</p>
        </div>
        <div className="rounded-lg border border-line p-4">
          <p className="text-sm text-muted">Revenus (net estimé)</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Link to="/espace-vendeur/annonces" className="card flex items-center gap-4 hover:shadow-md transition-shadow">
          ...
          <div>
            ...
            <p className="text-sm text-muted">Gérer mes articles en vente</p>
          </div>
        </Link>
        <Link to="/espace-vendeur/annonces/creer" className="card flex items-center gap-4 hover:shadow-md transition-shadow">
          <PlusCircle className="h-8 w-8" />
          <div>
            <p className="font-semibold">Nouvelle annonce</p>
            <p className="text-sm text-muted">Mettre un article en vente</p>
          </div>
        </Link>
        <Link to="/espace-vendeur/commandes" className="card flex items-center gap-4 hover:shadow-md transition-shadow">
          ...
          <div>
            ...
            <p className="text-sm text-muted">Suivre les achats de mes articles</p>
          </div>
        </Link>
      </div>
    </div>
